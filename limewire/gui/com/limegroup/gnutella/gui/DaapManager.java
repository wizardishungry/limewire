                    ...
                    Thread serverThread = ThreadExecutor.newManagedThread(new Runnable() {
                        public void run() {
                            try {
                                ...
                                if (!handleError(t)) {
                                    GUIMediator.showError(I18n.tr("LimeWire encountered an error in the Digital Audio Access Protocol (for sharing files in iTunes). This feature will be turned off. You can turn it back on in options, under iTunes -> Sharing."));
