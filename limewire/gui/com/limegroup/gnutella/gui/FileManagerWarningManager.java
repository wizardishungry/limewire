...
public final class FileManagerWarningManager implements FileEventListener {
    ...
    public synchronized void handleFileEvent(FileManagerEvent evt) {
        ...
        if (evt.getFileManager().getNumFiles() == SharingSettings.FILES_FOR_WARNING.getValue()) {
            ...
            doWarning(I18n.tr(
                            "You are sharing a lot of files through LimeWire, {0} files and counting. Do you mean to share all these files? Please review your sharing settings and which files are shared to ensure you aren't sharing any sensitive files.",
